      ...
      <tr>
        <td><table border="3" cellspacing="4" cellpadding="6">
          ...
          <tr>
            ...
            <td class="main">
              <?php echo zen_draw_textarea_field('metatags_bottom_keywords[' . $languages[$i]['id'] . ']', 'soft', '100%', '10', (isset($metatags_bottom_keywords[$languages[$i]['id']])) ? stripslashes($metatags_bottom_keywords[$languages[$i]['id']]) : zen_get_metatags_bottom_keywords($pInfo->products_id, $languages[$i]['id'])); //,'id="'.'metatags_keywords' . $languages[$i]['id'] . '"'); ?>
            </td>
          </tr>
          <tr>
