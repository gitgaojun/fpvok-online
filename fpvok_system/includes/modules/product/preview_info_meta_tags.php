...
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    if (zen_not_null($_POST)) {
      ...
      $metatags_bottom_keywords = $_POST['metatags_bottom_keywords'];
    ...
    for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
      if (isset($_GET['read']) && ($_GET['read'] == 'only')) {
        ...
        $pInfo->metatags_bottom_keywords = zen_get_metatags_bottom_keywords($pInfo->products_id, $languages[$i]['id']);
        ...
        $pInfo->metatags_bottom_keywords = zen_db_prepare_input($metatags_bottom_keywords[$languages[$i]['id']]);
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="3" cellspacing="4" cellpadding="6">
          ...
          <tr>
            <td class="main" valign="top"><?php echo TEXT_META_TAGS_BOTTOM_KEYWORDS; ?>&nbsp;</td>
            <td class="main" colspan="3"><?php echo $pInfo->metatags_bottom_keywords; ?></td>
          </tr>
          <tr>
...
/* Re-Post all POST'ed variables */
      ...
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
        ...
        echo zen_draw_hidden_field('metatags_bottom_keywords[' . $languages[$i]['id'] . ']', htmlspecialchars(stripslashes($metatags_bottom_keywords[$languages[$i]['id']])));
