...
?>
          ...
          <tr>
		  <td class="main">contact email:</td>
            <td  class="main"><?php echo $pInfo->faqs_contact_mail ; ?></td>
          </tr>
<?php
...
//          if (HTML_EDITOR_PREFERENCE=="FCKEDITOR") require(DIR_WS_INCLUDES.'fckeditor.php');
          ...
          $oFCKeditor->CreateFCKeditor( 'faqs_description[' . $languages[$i]['id'] . ']', '99%', '230' ) ;  //instanceName, width, height (px or %)
