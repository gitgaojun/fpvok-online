 ...
 * @version $Id: update_product_meta_tags.php 3009 2006-02-11 15:41:10Z wilt $
 */
...
// check if new meta tags or existing
          ...
          for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
            ...
            $sql_data_array = array('metatags_title' => zen_db_prepare_input($_POST['metatags_title'][$language_id]),
                                    ...
                                    'metatags_bottom_keywords' => zen_db_prepare_input($_POST['metatags_bottom_keywords'][$language_id]),
