...
// email disclaimer
  ...
  define('EMAIL_FOOTER_COPYRIGHT','Copyright &copy; ' . date('Y') . ' <a href="http://www.cec.hk" target="_blank">Zen Cart 中文版</a>。Powered by <a href="http://www.cec.hk" target="_blank">cec.hk</a>');
