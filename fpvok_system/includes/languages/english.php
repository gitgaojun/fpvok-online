...
define('TABLE_HEADING_CHECKBOX', '选择');
define('TABLE_HEADING_CUSTOMER_EMAIL', '客户邮件');
define('TABLE_HEADING_FEATURED', '推荐');
...
define('MODULE_SHIPPING_SINGPOST_TEXT_TITLE', 'SingPost');
...
define('BOX_CATALOG_SPECIALS', 'Special Products');
...
define('BOX_TOOLS_HOME_FLASH_IMAGE_MANAGER', '首页flash图片管理');
...
define('BOX_TOOLS_WATERMARK','水印图片生成');
...
define('BOX_CATALOG_FEATURED','Recommended for You');
define('BOX_CATALOG_FREESHIPPING','免运费商品');
define('BOX_CATALOG_NEW_ARRIVALS','New Arrivals');
...
// admin activity log warnings
  ...
  define('TEXT_ACCESS_DENIED', '对不起，你无权限访问此资源。如果你认为这样不正确请联系网站管理员 ,给您带来不便请谅解。');

  
  define('PRODUCT_MEDIUM_SMALL_WIDTH','90');
  define('PRODUCT_MEDIUM_SMALL_HEIGHT','90');
  define('PRODUCT_MEDIUM_IMAGE_WIDTH','280');
  define('PRODUCT_MEDIUM_IMAGE_HEIGHT','280');
  define('PRODUCT_MEDIUM_LARGE_WIDTH','600');
  define('PRODUCT_MEDIUM_LARGE_HEIGHT','600');
///////////////////////////////////////////////////////////
