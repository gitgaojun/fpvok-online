...
// Products and Attribute Copy Options
  ...
  define('TEXT_CATEGORIES_TYPES', '<strong>选择分类类型：</strong>');
  define('TEXT_CATEGORIES_TYPES_1', '一般类型');
  define('TEXT_CATEGORIES_TYPES_2', '推荐分类');
  define('TEXT_CATEGORIES_TYPES_3', 'Shopping by Categories');
	
  define('TEXT_CATEGORIES_DISPLAY_TYPES', '<strong>选择分类显示方式：</strong>');
  define('TEXT_CATEGORIES_DISPLAY_TYPES_1', '分类列表');
  define('TEXT_CATEGORIES_DISPLAY_TYPES_2', '产品列表');
  define('TEXT_CATEGORIES_DISPLAY_TYPES_3', '精简的产品列表');

  define('TEXT_PRODUCT_LIST_TYPES', '<strong>选择产品列表的显示方式：</strong>');
  define('TEXT_PRODUCT_LIST_TYPES_1', '列表');
  define('TEXT_PRODUCT_LIST_TYPES_2', '平铺');
  define('TEXT_PRODUCT_LIST_TYPES_3', '缩略图');
...
define('TEXT_CATEGORIES_BOTTOM_DESCRIPTION', '底部分类简介：');
define('TEXT_PRODUCT_GENERAL_DESCRIPTION', '产品概述 ：');
 ...
 * addBy showq@qq.com
 */
	define('TEXT_CATEGORIES_BANNER_FIRST','banner 1');
	define('TEXT_CATEGORIES_BANNER_SECOND','banner 2');
	define('TEXT_CATEGORIES_BANNER_LINK_FIRST','banner 1 链接 (Contain "http://")');
	define('TEXT_CATEGORIES_BANNER_LINK_SECOND','banner 2 链接 (Contain "http://")');
	define('TEXT_BANNER1_IMAGES_DELETE', '<strong>删除Banner1图片？</strong> 注意：只是从产品表里删除，图片还没有从服务器上删除：');
	define('TEXT_BANNER2_IMAGES_DELETE', '<strong>删除Banner２图片？</strong> 注意：只是从产品表里删除，图片还没有从服务器上删除：');
?>