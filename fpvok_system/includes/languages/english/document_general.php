...
define('TEXT_DOCUMENT_STATUS', '商品状态:');
...
define('TEXT_DOCUMENT_DATE_AVAILABLE', '到货日期:');
define('TEXT_DOCUMENT_AVAILABLE', '有货');
define('TEXT_DOCUMENT_NOT_AVAILABLE', '缺货');
...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', '特定, 可下载商品需要送货地址');
...
define('TEXT_DOCUMENT_DETAILS', '文档简介:');
define('TEXT_DOCUMENT_IMAGE', '文档图像:');
define('TEXT_DOCUMENT_IMAGE_DIR', '上传目录:');
define('TEXT_DOCUMENT_URL', '文档网址:');
define('TEXT_DOCUMENT_URL_WITHOUT_HTTP', '<small>(不要 http://)</small>');
...
// Products and Attribute Copy Options
  define('TEXT_COPY_ATTRIBUTES_ONLY','仅用于复制商品 ...');
...
// meta tags
  define('TEXT_META_TAG_TITLE_INCLUDES','<strong>文件的Meta标签标题应包括:</strong>');
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>文件名:</strong>');
