...
define('TEXT_PRODUCTS_INFORMATION_TITLE', '产品信息：');
define('TEXT_PRODUCTS_IMAGE_INFORMATION_TITLE', '产品图片信息：');
define('TEXT_PRODUCTS_IMAGE_UPLOADS_ATTACHMENTS', '上传附件');
define('TEXT_PRODUCTS_SHIPPING_INFORMATION_TITLE', '产品送货信息：');
define('TEXT_PRODUCTS_QUANTITY_INFORMATION_TITLE', '产品数量信息：');
...
define('TEXT_PRODUCTS_FROM', '商品来源:');
define('TEXT_PRODUCTS_MANUFACTURER', '商品厂商:');
define('TEXT_PRODUCTS_NAME', '商品名称:');
define('TEXT_PRODUCTS_SMALL_DESCRIPTION', '产品简短描述：');
...
define('TEXT_PRODUCTS_SAMPLE_PRICE_NET', '产品样价（基本价）：');
define('TEXT_PRODUCTS_SAMPLE_PRICE_GROSS', '产品样价（含税价）：');
...
// Products and Discount Copy Options
  ...
  define('TEXT_PRODUCTS_PRICE_INFORMATION_TITLE', '产品价格信息：');
  ...
  define('TEXT_PRICE_RETAIL_NET', '产品零售价（基本价）：');
  define('TEXT_PRICE_RETAIL_GROSS', '产品零售价（含税价）：');
