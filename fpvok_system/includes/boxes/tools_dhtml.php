...
if (menu_header_visible('Tools')=='true') {
  ...
  $options = array( array('box' => BOX_TOOLS_TEMPLATE_SELECT, 'page' => FILENAME_TEMPLATE_SELECT),
                    ...
                    array('box' => BOX_TOOLS_HOME_FLASH_IMAGE_MANAGER, 'page' => FILENAME_HOME_FLASH_IMAGE_MANAGER),
                    ...
                    array('box' => BOX_TOOLS_WATERMARK, 'page' => FILENAME_WATERMARK),
                    array('box' => 'Products DB Repair', 'page' => 'products_db_repair')
                  );
