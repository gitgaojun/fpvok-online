...
// auto expire freeshipping products
  require(DIR_FS_CATALOG . DIR_WS_FUNCTIONS . 'freeshipping.php');
  zen_start_freeshipping();
  zen_expire_freeshipping();
    
// auto expire new arrivals
  require(DIR_FS_CATALOG . DIR_WS_FUNCTIONS . 'new_arrivals.php');
  zen_start_new_arrivals();
  zen_expire_new_arrivals();
