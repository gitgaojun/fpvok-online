...
<script type="text/javascript">var baseURL = "http://localhost/lightinthebox/"</script>
...
<script language="javascript" src="includes/javascript/productZoom.js"></script>
    ...
    switch ($action) {
      case 'new_category':
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
          $category_inputs_string .= '<br />' . zen_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']) . '&nbsp;' . zen_draw_input_field('categories_name[' . $languages[$i]['id'] . ']', '', ' size="120"');
        }
