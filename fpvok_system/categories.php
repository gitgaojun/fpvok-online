 ...
 */
 ...
 // if (!category_allowed($_POST['categories_id'])) 
  ...
  if (!isset($_SESSION['categories_products_sort_order'])) {
    $_SESSION['categories_products_sort_order'] = 0;
  }
  ...
  if (zen_not_null($action)) {
    switch ($action) {
      ...
      $categories_type = zen_db_prepare_input($_POST['categories_type']);
      $categories_display_type = zen_db_prepare_input($_POST['categories_display_type']);
      $categories_list_types = zen_db_prepare_input($_POST['categories_list_types']);
      $categories_banner_1_link = zen_db_prepare_input($_POST['categories_banner_1_link']);
      $categories_banner_2_link = zen_db_prepare_input($_POST['categories_banner_2_link']);

      $sql_data_array = array('sort_order' => (int)$sort_order,'categories_type' => $categories_type,'categories_display_type' => $categories_display_type ,'categories_list_types' =>$categories_list_types, 'categories_banner_1_link' => $categories_banner_1_link, 'categories_banner_2_link' => $categories_banner_2_link);
      ...
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
        ...
        $categories_bottom_description_array = $_POST['categories_bottom_description'];
		$categories_info_description_array = $_POST['product_info_text'];
        ...
        $sql_data_array = array('categories_name' => zen_db_prepare_input($categories_name_array[$language_id]),
                                ...
                                'categories_bottom_description' => ($categories_bottom_description_array[$language_id] == '<p />' ? '' : zen_db_prepare_input($categories_bottom_description_array[$language_id])),
                                'product_info_text' => ($categories_info_description_array[$language_id] == '<p />' ? '' : zen_db_prepare_input($categories_info_description_array[$language_id])));
...
<?php
  ...
  switch ($action) {
    ...
    $languages = zen_get_languages();
    for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
      $category_inputs_string .= '<br />' . '' . '&nbsp;' . zen_draw_input_field('categories_name[' . $languages[$i]['id'] . ']', '', zen_set_field_length(TABLE_CATEGORIES_DESCRIPTION, 'categories_name'));
    }
...
//        $category_inputs_string .= '<INPUT type="hidden" name="categories_description[' . $languages[$i]['id']  . ']" ' . 'value=' . "'" . zen_get_category_description($cInfo->categories_id, $languages[$i]['id']) . "'>";
    ...
    //TODO insert categories bottom description

    $category_inputs_bottom_string = '';$category_inputs_info_string = '';
    for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
      $category_inputs_bottom_string .= '<br />' . '' . '&nbsp;';
      if ($_SESSION['html_editor_preference_status']=='FCKEDITOR') {
...
//        $category_inputs_string .= '<INPUT type="hidden" name="categories_description[' . $languages[$i]['id']  . ']" ' . 'value=' . "'" . zen_get_category_description($cInfo->categories_id, $languages[$i]['id']) . "'>";
    ...
    for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
      $category_inputs_info_string .= '<br />' . '' . '&nbsp;';

      if ($_SESSION['html_editor_preference_status']=='FCKEDITOR') {
                $oFCKeditor = new FCKeditor('product_info_text[' . $languages[$i]['id']  . ']') ;
                $oFCKeditor->Value = zen_get_category_info_description($cInfo->categories_id, $languages[$i]['id']);
                $oFCKeditor->Width  = '90%' ;
                $oFCKeditor->Height = '100' ;
//                $oFCKeditor->Config['ToolbarLocation'] = 'Out:xToolbar' ;
//                $oFCKeditor->Create() ;
...
//        $category_inputs_string .= '<INPUT type="hidden" name="categories_description[' . $languages[$i]['id']  . ']" ' . 'value=' . "'" . zen_get_category_description($cInfo->categories_id, $languages[$i]['id']) . "'>";
        ...
        $category_inputs_info_string .= zen_draw_textarea_field('product_info_text[' . $languages[$i]['id'] . ']', 'soft', '100%', '20', zen_get_category_info_description($cInfo->categories_id, $languages[$i]['id']));
      }
    }
	

	$contents[] = array('text' => '<br />Product general description:' . $category_inputs_info_string);	
    ...
    //TODO Categories display Types
    $contents[] = array('text' => '<br />' . TEXT_CATEGORIES_DISPLAY_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_display_type',1,true).TEXT_CATEGORIES_DISPLAY_TYPES_1.'&nbsp;' .zen_draw_radio_field('categories_display_type',2).TEXT_CATEGORIES_DISPLAY_TYPES_2.'&nbsp;' .zen_draw_radio_field('categories_display_type',3).TEXT_CATEGORIES_DISPLAY_TYPES_3);
		//TODO Products Listing display Types
    $contents[] = array('text' => '<br />' . TEXT_PRODUCT_LIST_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_list_types',1,true).TEXT_PRODUCT_LIST_TYPES_1.'&nbsp;' .zen_draw_radio_field('categories_list_types',2).TEXT_PRODUCT_LIST_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_list_types',3). TEXT_PRODUCT_LIST_TYPES_3);
...
// split line for beauty
		$contents[] = array('text' => '<hr>');
// end split line for beauty
 
//imagesBanner 1 addBy showq@qq.com TODO newCategory
    ...
    $default_banner_directory = 'banners/';
    $contents[] = array('text' => TEXT_CATEGORIES_IMAGE_DIR . ' ' . zen_draw_pull_down_menu('img_dir_banner1', $dir_info, $default_banner_directory));
    ...
    $contents[] = array('text' => zen_draw_input_field('categories_banner_1_link', ''));
//end imagesBanner 1
// split line for beauty
		$contents[] = array('text' => '<hr>');
// end split line for beauty

//imagesBanner 2 addBy showq@qq.com TODO newCategory
    ...
    $contents[] = array('text' => TEXT_CATEGORIES_IMAGE_DIR . ' ' . zen_draw_pull_down_menu('img_dir_banner2', $dir_info, $default_banner_directory));
    $contents[] = array('text' => TEXT_CATEGORIES_IMAGE_MANUAL . '&nbsp;' . zen_draw_input_field('categories_banner2_manual'));
		...
		$contents[] = array('text' => zen_draw_input_field('categories_banner_2_link', ''));
    //end imagesBanner 2
...
// end split line for beauty
    ...
    $category_inputs_string = '';
    for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
      $category_inputs_string .= '<br />' . '' . '&nbsp;' . zen_draw_input_field('categories_name[' . $languages[$i]['id'] . ']', zen_get_category_name($cInfo->categories_id, $languages[$i]['id']), zen_set_field_length(TABLE_CATEGORIES_DESCRIPTION, 'categories_name'));
    }
...
//                $oFCKeditor->Create() ;
                $output = $oFCKeditor->CreateHtml() ;
        $category_inputs_info_string .= '<br />' . $output;
...
//        $category_inputs_string .= '<INPUT type="hidden" name="categories_description[' . $languages[$i]['id']  . ']" ' . 'value=' . "'" . zen_get_category_description($cInfo->categories_id, $languages[$i]['id']) . "'>";
    ...
    //TODO edit_categories - categories_display_type
		switch($cInfo->categories_display_type){
    case 2:
    $contents[] = array('text' => '<br />' . TEXT_CATEGORIES_DISPLAY_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_display_type',1).TEXT_CATEGORIES_DISPLAY_TYPES_1.'&nbsp;' . zen_draw_radio_field('categories_display_type',2,true). TEXT_CATEGORIES_DISPLAY_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_display_type',3). TEXT_CATEGORIES_DISPLAY_TYPES_3);
		break;
    case 3:
    $contents[] = array('text' => '<br />' . TEXT_CATEGORIES_DISPLAY_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_display_type',1).TEXT_CATEGORIES_DISPLAY_TYPES_1.'&nbsp;' . zen_draw_radio_field('categories_display_type',2). TEXT_CATEGORIES_DISPLAY_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_display_type',3,true). TEXT_CATEGORIES_DISPLAY_TYPES_3);
		break;
    default:
    $contents[] = array('text' => '<br />' . TEXT_CATEGORIES_DISPLAY_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_display_type',1,true).TEXT_CATEGORIES_DISPLAY_TYPES_1.'&nbsp;' . zen_draw_radio_field('categories_display_type',2). TEXT_CATEGORIES_DISPLAY_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_display_type',3). TEXT_CATEGORIES_DISPLAY_TYPES_3);
		break;		
    ...
    //TODO edit_categories - products listing list type
    switch($cInfo->categories_list_types){
    case 2:
    $contents[] = array('text' => '<br />' . TEXT_PRODUCT_LIST_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_list_types',1).TEXT_PRODUCT_LIST_TYPES_1.'&nbsp;' . zen_draw_radio_field('categories_list_types',2,true). TEXT_PRODUCT_LIST_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_list_types',3). TEXT_PRODUCT_LIST_TYPES_3);
    break;    
    case 3:
    $contents[] = array('text' => '<br />' . TEXT_PRODUCT_LIST_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_list_types',1).TEXT_PRODUCT_LIST_TYPES_1.'&nbsp;' . zen_draw_radio_field('categories_list_types',2). TEXT_PRODUCT_LIST_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_list_types',3,true). TEXT_PRODUCT_LIST_TYPES_3);
    break;    
    default:
    $contents[] = array('text' => '<br />' . TEXT_PRODUCT_LIST_TYPES . '&nbsp;&nbsp;' . zen_draw_radio_field('categories_list_types',1,true).TEXT_PRODUCT_LIST_TYPES_1.'&nbsp;' . zen_draw_radio_field('categories_list_types',2). TEXT_PRODUCT_LIST_TYPES_2.'&nbsp;' . zen_draw_radio_field('categories_list_types',3). TEXT_PRODUCT_LIST_TYPES_3);
    break;    
    ...
    $contents[] = array('text' => TEXT_CATEGORIES_IMAGE_MANUAL . '&nbsp;' . zen_draw_input_field('categories_image_manual'));
