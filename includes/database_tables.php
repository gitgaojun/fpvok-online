...
define('TABLE_FREE_SHIPPINGS', DB_PREFIX . 'freeshipping');
...
define('TABLE_ASK', DB_PREFIX . 'ask');
define('TABLE_ASK_DESCRIPTION', DB_PREFIX . 'ask_description');
define('TABLE_FEATURED_HOT', DB_PREFIX . 'featured_hot');
...
define('TABLE_ORIGIN', DB_PREFIX . 'customers_origin');
define('TABLE_ORIGIN_FREQ', DB_PREFIX . 'customers_origin_freq');
...
define('TABLE_UN_PRODUCTS_TO_WISHLISTS', DB_PREFIX . 'un_products_to_wishlists');
define('TABLE_UN_WISHLISTS', DB_PREFIX . 'un_wishlists');
define('TABLE_FEATURED', DB_PREFIX . 'featured');
define('TABLE_FREESHIPPING', DB_PREFIX . 'freeshipping');
define('TABLE_NEW_ARRIVALS', DB_PREFIX . 'new_arrivals');
