...
define('FILENAME_MANAGER_ADDRESS', 'manager_address');
...
define('FILENAME_HOME_FLASH_IMAGE_MANAGER', 'home_flash_image_manager');
define('FILENAME_BANNER_STATISTICS', 'banner_statistics');
define('FILENAME_FEATURED_HOT', 'featured_hot');
define('FILENAME_CACHE', 'cache');
define('FILENAME_ASK', 'ask_question');
...
define('FILENAME_CONTACT_US_FRAME', 'contact_us_frame');
...
define('FILENAME_DEFINE_CONTACT_US_FRAME', 'define_contact_us_frame');
...
define('FILENAME_DEFINE_SEE_ALL', 'define_see_all');
...
define('FILENAME_FREESHIPPING','freeshipping');
define('FILENAME_NEW_ARRIVALS','new_arrivals');
...
define('FILENAME_CHECKOUT_LOGIN', 'checkout_login');
...
define('FILENAME_POPUP_ASK_A_QUESTION', 'popup_ask_a_question');
define('FILENAME_LARGE_ORDER_INQUIRY', 'large_order_inquiry');
...
define('FILENAME_BEST_DEAL', 'best_deal');
define('FILENAME_FREE_SHIPPING', 'free_shipping');
...
define('FILENAME_SHIPPING_ESTIMATOR', 'shipping_estimator');
define('FILENAME_POPUP_SHIPPING_ESTIMATOR', 'popup_shipping_estimator');
...
define('FILENAME_WATERMARK','watermark');
...
define('FILENAME_WHOS_ONLINE', 'whos_online');
			...
			//addBy show
			define('FILENAME_SEE_ALL','see_all');
			define('FILENAME_PRODUCT_TAGS','producttags');
      define('FILENAME_PRINT', 'print');
...
define('FILENAME_VIP_LINK', 'vip.html');

//New 
define('FILENAME_LAYER_SWITCH','layer_switch.php');
define('FILENAME_BOTTOM_FEATURED_MODULE','bottom_featured.php');
