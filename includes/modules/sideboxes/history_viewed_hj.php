...
// test if box should display
  ...
  if ($show_recently_viewed == true) {
		$title_link = false;
		require($template->get_template_dir('tpl_history_viewed_hj.php',DIR_WS_TEMPLATE, $current_page_base,'sideboxes'). '/tpl_history_viewed_hj.php');
		$title =  BOX_HEADING_HISTORY_VIEWED;
		require($template->get_template_dir('tpl_history_viewed_hj.php', DIR_WS_TEMPLATE, $current_page_base,'common') . '/tpl_history_viewed_hj.php');
  }else{
     echo 'You have no recently viewed items or searches';
  }
?>
