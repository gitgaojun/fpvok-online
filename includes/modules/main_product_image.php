...
if(is_int(strrpos($products_image, ','))){
  ...
  // $products_image_medium[$i] = DIR_WS_IMAGES .$products_image_base[$i]. $products_image_extension[$i];
 ...
 //35blue 2009-3-4 19:37:55	
   //$products_image_medium = DIR_WS_IMAGES .$products_image_base.$products_image_extension[$i];
   if(stripos($products_image_base, 's/')==0 && is_int(stripos($products_image_base, 's/'))) 
