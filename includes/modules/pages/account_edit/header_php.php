	...
	switch ($_POST['action']){
		case 'email_information':
				  ...
				  if ($error == false) {
				    ...
				    $old_addr_check=$db->Execute("select customers_email_address,customers_telephone from ".TABLE_CUSTOMERS." where customers_id='".(int)$_SESSION['customer_id']."'");				
				    ...
				    $sql_data_array = array(array('fieldName'=>'entry_gender', 'value'=>$gender, 'type'=>'string'),
																	...
																	array('fieldName'=>'entry_phone', 'value'=>$customers_telephone, 'type'=>'string'),			    												
				    ...
				    if(strlen($old_addr_check->fields['customers_telephone'])<=0){
