...
switch (true) {
  ...
  $totalsDisplay = TEXT_TOTAL_ITEMS ."<strong>  ". $_SESSION['cart']->count_contents() ."</strong>&nbsp;&nbsp;&nbsp;&nbsp;". TEXT_TOTAL_WEIGHT ."<strong>  ". $shipping_weight. TEXT_PRODUCT_WEIGHT_UNIT ."</strong>&nbsp;&nbsp;&nbsp;&nbsp;". TEXT_TOTAL_AMOUNT . "<strong>  ".$currencies->format($_SESSION['cart']->show_total()."</strong>");
  break;
  case (SHOW_TOTALS_IN_CART == '2'):
  $totalsDisplay = TEXT_TOTAL_ITEMS ."<strong>  ". $_SESSION['cart']->count_contents() ."</strong>&nbsp;&nbsp;&nbsp;&nbsp;". ($shipping_weight > 0 ? TEXT_TOTAL_WEIGHT . "<strong>  &nbsp;&nbsp;&nbsp;&nbsp;".$shipping_weight . TEXT_PRODUCT_WEIGHT_UNIT."</strong>" : '') . TEXT_TOTAL_AMOUNT . $currencies->format($_SESSION['cart']->show_total()."</strong>");
  break;
  case (SHOW_TOTALS_IN_CART == '3'):
  $totalsDisplay = TEXT_TOTAL_ITEMS ."<strong>  ". $_SESSION['cart']->count_contents() ."</strong>&nbsp;&nbsp;&nbsp;&nbsp;". TEXT_TOTAL_AMOUNT . "<strong>  &nbsp;&nbsp;&nbsp;&nbsp;".$currencies->format($_SESSION['cart']->show_total()."</strong>");
  break;
}
...
for ($i=0, $n=sizeof($products); $i<$n; $i++) {
  ...
  $productsImage = (IMAGE_SHOPPING_CART_STATUS == 1 ? zen_image(DIR_WS_IMAGES . $products[$i]['image'], SEO_COMMON_KEYWORDS . ' ' .$products[$i]['name'], IMAGE_SHOPPING_CART_WIDTH, IMAGE_SHOPPING_CART_HEIGHT) : '');
