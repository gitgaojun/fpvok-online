...
//  $display_limit = zen_get_products_new_timelimit();
  ...
  $products_new_split = new splitPageResults($products_new_query_raw, (isset($_GET['pagesize']) ? $_GET['pagesize'] : 25));
...
//check to see if we are in normal mode ... not showcase, not maintenance, etc
  ...
  $products_new_split2 = new splitPageResults($products_new_query_raw2, (isset($_GET['pagesize']) ? $_GET['pagesize'] : 25));
