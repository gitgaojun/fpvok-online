...
$fcPath = zen_get_faqs_faq_category_id2($_GET['$faqs_id']);
  ...
  $sql = "select faq_categories_name as faqs_name from faq_categories_description where faq_categories_id = '" . (int)$_GET['fcPath'] . "' and language_id = '" . (int)$_SESSION['languages_id'] . "'";
  }
