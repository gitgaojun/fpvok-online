...
// eof: previous next
 ...
 $sql = "select faq_categories_name as faqs_name,faq_categories_description as faqs_description from faq_categories_description where faq_categories_id = '" . (int)$_GET['fcPath'] . "' and language_id = '" . (int)$_SESSION['languages_id'] . "'";
