...
$reviews_query_raw = "SELECT r.reviews_id, left(rd.reviews_text, 100) AS reviews_text,rd.reviews_admin, r.reviews_rating, r.date_added, p.products_id, pd.products_name, p.products_image, r.customers_name 
