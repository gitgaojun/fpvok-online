...
switch(true) {
  ...
  default:
    ...
    $category_icon_display_image = zen_image(DIR_WS_IMAGES . $category_icon_display_image, SEO_COMMON_KEYWORDS . ' ' .$category_icon_display_name, CATEGORY_ICON_IMAGE_WIDTH, CATEGORY_ICON_IMAGE_HEIGHT) . '<br />';
    break;
}
//    }
?>