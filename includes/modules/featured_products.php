...
/** 首页小图到大图的改动 **/
foreach ($list_box_contents as $key => $value) {
	foreach ($value as $k2 => $v2) {
		$list_box_contents[$key][$k2]['text'] = str_replace('images/s/', 'images/l/', $v2['text']);
	}
}
