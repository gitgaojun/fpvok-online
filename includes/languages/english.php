...
//These Constant addBy shOwQ
	...
	define('SEO_COMMON_KEYWORDS','');
	define('SEO_COMMON_KEYWORDS_ASSISTANCE','Discount');
	define('SEO_COMMON_KEYWORDS_ASSISTANCE2','China');
...
//split_page_results.php
	...
	define('TABLE_HEADING_FINAL_PRICE','Unit Price');
...
Navigation: <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">Free Shipping</a>, <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">Buy wholesale products</a> at <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">wholesale price</a> from leading <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">Chinese wholesalers</a>, enjoy <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">online wholesale</a> and become a <a href="'.HTTP_SERVER.DIR_WS_CATALOG.'">wholesaler</a> now!<br/><h1 class="big gray b_ g_t_c" >China Wholesale,Buy Wholesale Products from China - test9 is one of the biggest Chinese Wholesaler. </h1>'
); 
...
// categories_css box text in sideboxes/categories_css.php
  define('BOX_HEADING_CATEGORIES', 'All Categories');
...
// whats_new box text in sideboxes/whats_new.php
  ...
  define('TEXT_DISPLAY_NUMBER_OF_FEATURED_PRODUCTS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> Hot Products)');
...
// javascript messages
  ...
  define('ENTRY_STREET_ADDRESS', 'Address Line1:');
  ...
  define('ENTRY_WHICH_BEST_YOU', 'Which one describes you the best?');
  ...
  define('FORM_SKIP_TO_ADDRESS_TEXT', ' Be sure to click "<strong class="red">Ship to this address</strong>" when done.');
  define('ENTRY_REQUIRED_SYMBOL', '*');

  // constants for use in zen_prev_next_display function
  define('TEXT_RESULT_PAGE', '');
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', '<span style="display:none;">%d</span><strong>%d</strong>');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_BEST_DEAL', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> Best Deals)');
    define('TEXT_DISPLAY_NUMBER_OF_LOW_PRICE', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> Best Deals)');
...
// banner_box
  define('BOX_HEADING_BANNER_BOX','');
  define('TEXT_BANNER_BOX','Click Here ...');
...
// banner_box - all
  ...
  define('TEXT_BANNER_BOX_ALL','Click Here ...');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_FEATURED_PRODUCTS','Hot Products');
