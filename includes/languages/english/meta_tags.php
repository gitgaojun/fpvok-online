...
// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'FPVOK is the supplier of global specialized FPV/UAV system,Wholesale top quality FPV/UAV products directly from RC manufacturers.');
  define('HOME_PAGE_META_KEYWORDS', 'FPV, FPV system, UAV products,Aerial Equipment,Video transmission equipment');
  define('HOME_PAGE_TITLE', 'Professional Supplier For FPV/UAV - FPVOK.COM');
