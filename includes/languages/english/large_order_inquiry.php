...
define('NAVBAR_TITLE', 'Large order inquiry');
...
define('TARGET_PRICE', 'Your Target Price:');
define('ORDER_QUANTITY', 'Order Quantity:');
define('ENTRY_NAME', 'Full Name:');
define('ENTRY_EMAIL', 'Email Address:');
define('ENTRY_ENQUIRY', 'Detailed Enquiry Information:');
