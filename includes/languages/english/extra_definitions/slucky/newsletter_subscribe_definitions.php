...
//  
  ...
  define('BOX_HEADING_SUBSCRIBE', 'Newsletter<br/>Subscription'); // sidebox title
  
  define('BUTTON_IMAGE_SUBSCRIBE', 'button_subscribe.gif');
  define('BUTTON_SUBSCRIBE_ALT', 'Subscribe');
  define('BOX_SUBSCRIBE_DEFAULT_TEXT', 'Get New Arrivals, Updates, Discounts and Special Offers from fpvok.com!');
