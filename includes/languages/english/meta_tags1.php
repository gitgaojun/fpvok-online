...
// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'wholesale video game accessories from fpvok.com, 3DS accessories,PS3 laser lens,PSP LCD Screen,iPad leather and bag, Xbox360 controllers and adapters, PS3 move,Wii remote & nunchuk, iphone leather and case, Ndsi accessories,Ndsi LL/XL, cables & chargers.');
  define('HOME_PAGE_META_KEYWORDS', 'china wholesale, china electronics wholesale, wholesale electronics, dropship, china dropshipper, cheap electronics wholesaler, electronics supplier, china supplier, china wholesaler');
  define('HOME_PAGE_TITLE', 'China Wholesale - Wholesale Electronics - Dropship from China - China Electronics Supplier');
...
// Define Fourth Section Output
  define('FOURTH_SECTION', ' from ');
