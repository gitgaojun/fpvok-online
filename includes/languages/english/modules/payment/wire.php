...
//
  ...
  define('MODULE_PAYMENT_WIRE_TEXT_EMAIL_FOOTER', "Make Payable To:\n\n" . MODULE_PAYMENT_WIRE_TEXT_CONFIG_2_1 . MODULE_PAYMENT_WIRE_NAME . " - " . MODULE_PAYMENT_WIRE_TEXT_CONFIG_3_1 . MODULE_PAYMENT_WIRE_ACCOUNT . " - "  . MODULE_PAYMENT_WIRE_TEXT_CONFIG_4_1 . MODULE_PAYMENT_WIRE_TELEPHONE . " - "  . MODULE_PAYMENT_WIRE_TEXT_CONFIG_5_1 . MODULE_PAYMENT_WIRE_BANK_NAME . " - "  . MODULE_PAYMENT_WIRE_TEXT_CONFIG_6_1 . MODULE_PAYMENT_WIRE_BANK_ADDRESS . " - "  . MODULE_PAYMENT_WIRE_TEXT_CONFIG_7_1 . MODULE_PAYMENT_WIRE_SWIFT_CODE . "\n\n" . '<b>Attention: </b>'."\n\n".'- The total order quotation have not included Bank Transfer fee. Here, we cannot afford any Bank Transfer handing charge. So, please ensure that you should make the full enough payment for your this order.' . "\n\n" .  '- After you make the payment, please send a notification email to this address: <b>sales@fpvok.com</b>, Your order will not be shipped until we receive the payment. When we confirmed the payment, we will notify you and start to process this order as soon as possible. ');
  
  define('MODULE_PAYMENT_WIRE_MARK_BUTTON_IMG', 'includes/templates/slucky/images/checkout/ico_Wire.gif');
  define('MODULE_PAYMENT_WIRE_MARK_BUTTON_ALT', 'Wire Transfer Payment');
  define('MODULE_PAYMENT_WIRE_ACCEPTANCE_MARK_TEXT', 'Wire Transfer Payment');
  ...
  define('MODULE_PAYMENT_WIRE_TEXT_NOTICE',' Please e-mail your <b>Order Number</b>, <b>Amount</b>, Sender\'s Name, Sender\'s Address, <b>Country</b> and <b>Contact Phone Number</b> to '.'<span class="red">sales@fpvok.com</span>'.' after you send payment by Wire Transfer. Thanks!');
