 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_IMG', 'includes/templates/slucky/images/checkout/pic_2.jpg');
  define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_ALT', 'Checkout with PayPal');
  define('MODULE_PAYMENT_PAYPAL_ACCEPTANCE_MARK_TEXT', ' - The safer, easier way to pay. What is <a href="http://www.paypal.com" target="_blank" rel="nofollow"> Paypal?</a>');

  define('MODULE_PAYMENT_PAYPAL_TEXT_CATALOG_LOGO', '<img  align="absmiddle" src="' . MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_IMG . '" alt="' . MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_ALT . '" title="' . MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_ALT . '" /> &nbsp;' . MODULE_PAYMENT_PAYPAL_ACCEPTANCE_MARK_TEXT);
  ...
  define('MODULE_PAYMENT_PAYPAL_PURCHASE_DESCRIPTION_TITLE', 'Purchase');
