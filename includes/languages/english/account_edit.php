...
//
define('NAVBAR_TITLE','My Profile');
define('NAVBAR_TITLE_1', 'My Account');
define('NAVBAR_TITLE_2', 'My Profile');
...
define('TEXT_WHICH_DESCRIBES','Which one describes you the best? ');
define('ERROR_CURRENT_PASSWORD_NOT_MATCHING', 'Error: Sorry, there is no match for that email address and/or password.');

define('COMPLATE_TEXT','Please complete your information,Otherwise you will not be able to conduct other operations');
?>
