<div id="container">
        ...
        <div class="Channel_box">
            <div class="fleft DropShipping_Clients">
				...
				<a href="/" style="margin-right:50px;" class="cblue fright">More</a>
    	...
    	<div class="Channel_box">
            ...
            <p class="f12 pl40">fpvok.com was established in 2008, is one of the top 3 China B2C e-Commerce companies, with over 70,000 items across almost 100 categories, we have below advantages:</p>
        ...
        <div class="Channel_box">
            ...
            <p class="f12 pl40 l15">Dropshipping is a business mode in which you do not keep goods in stock; instead you transfer your customer's order and shipment details to us. We will ship the goods directly to your customer, and the parcel will not have any information of us. You make profit on the price difference during the transaction.</p>
        ...
        <div style="padding-bottom:40px;" class="Channel_box">
            ...
            <div class="fleft Channel_box_items">
                ...
                <ul class="c5a5">
                    ...
                    <li class="mt5 mb5"><span class="Channel_icon01"></span><strong>Working from home</strong> + your own hours </li>
                    <li class="mt5 mb5"><span class="Channel_icon01"></span>Very <strong>low startup costs</strong> and operating costs</li>
                    <li class="mt5 mb5"><span class="Channel_icon01"></span><strong>No need</strong> warehouse, inventory, employee &amp; shipping</li>
                    <li class="mt5 mb5"><span class="Channel_icon01"></span>Focus on <strong>selling only</strong></li>
                </ul>
            </div>
            <div class="fright Channel_box_items">
                ...
                <ul class="c5a5">
                    ...
                    <li class="mt5 mb5"><span class="Channel_icon01"></span><strong>No need to pay</strong> the order until it has sold</li>
                    <li class="mt5 mb5"><span class="Channel_icon01"></span><strong>No minimum order</strong> requirements</li>
                    <li class="mt5 mb5"><span class="Channel_icon01"></span>Buy at <strong>wholesale price,</strong> sell at your own retail price</li>
                    <li class="mt5 mb5"><span class="Channel_icon01"></span><strong>Unlimited profit margin</strong></li>
                </ul>
            </div>
            <div class="clear"></div>
        </div>
        <div class="Channel_box">
            <span class="f14 fleft howtojoin">
                ...
                <ul style="margin-left:90px;">
                    ...
                    <li class="mt5 mb5 ml20"><span class="Channel_icon09"></span><a class="c004" field="register">Register</a> an account and <a class="c004" field="signin">sign in</a> your account</li>
