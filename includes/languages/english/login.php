...
define('NAVBAR_TITLE', 'Sign in or Register');
define('HEADING_TITLE', 'Sign in or Register');

define('HEADING_NEW_CUSTOMER', 'Register a New Account');
define('HEADING_NEW_CUSTOMER_SPLIT', 'New Customers');

define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'If you don\'t have an account with <strong>' . STORE_NAME .'</strong>, please create one.<br>');
...
define('HEADING_RETURNING_CUSTOMER', 'Sign in');
