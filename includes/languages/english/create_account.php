...
define('EMAIL_GREET_MR', 'Dear Customer,' . "\n\n");
define('EMAIL_GREET_MS', 'Dear Customer,' . "\n\n");
define('EMAIL_GREET_NONE', 'Dear Customer' . "\n\n");

// First line of the greeting
define('EMAIL_WELCOME', 'Welcome to . Here, we can Ship to Worldwide for every product and No Minimum Order Quantity.');
...
define('EMAIL_TEXT', 'Thanks for your registration in www.fpvok.com. Your account on our website has been activated and now you can select and purchase goods here freely.' . "\n\n" .'With your account, you can now take part in the <strong>various services</strong> we have to offer you. Some of these services include:' . "\n\n" . '<li><strong>Permanent Cart</strong> - Any products added to your online cart remain there until you remove them, or check them out.' . "\n\n" . '<li><strong>Address Book</strong> - Perfect for <strong>DropShipper</strong> and eBay sellers. We can now deliver your products to another address other than yours! This is perfect to send birthday gifts direct to the birthday-person themselves.' . "\n\n" . '<li><strong>Order History</strong> - View your history of purchases that you have made with us.' . "\n\n" . '<li><strong>Products Reviews</strong> - Share your opinions on products with our other customers.' . "\n\n");
define('EMAIL_CONTACT', 'For help with any of our online services, or if you have any question or suggestion about our website and products, please email the store-owner: <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS ." </a>\n\n");
