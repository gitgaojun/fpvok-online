...
*/
  ...
  function create($zf_ot_modules, $zf_mode = 2) {
	...
	$order_id = $_SESSION['payment']=='paypal' ? 1 : $this->info['order_status'];
...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode) {
    ...
    $html_msg['INTRO_ORDER_NUMBER']    = zen_get_order_no($zf_insert_id);
    ...
    $html_msg['ADDRESS_DELIVERY_DETAIL']    = ($this->content_type != 'virtual') ? zen_address_label($_SESSION['customer_id'], $_SESSION['sendto'], true, '', "<br />").'<br />Tel:'.$this->customer['telephone'] : 'n/a';
