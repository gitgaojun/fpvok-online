...
if (($products_new_split->number_of_rows > 0) && ((PREV_NEXT_BAR_LOCATION == '1') || (PREV_NEXT_BAR_LOCATION == '3'))) {
	?>
<div class="pagebar border_b white_bg"><span class="fl"><?php
	echo $products_new_split->display_count ( TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW );
	?></span>
<div class="split_pages"><?php
	echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links_version2 ( MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params ( array ('page', 'info', 'x', 'y', 'main_page' ) ) );
	?></div>
</div>
<?php
}
...
<div class="list_bar">
<ul>
	<li rel="nofollow"><strong>&nbsp;&nbsp;View:&nbsp;&nbsp;</strong></li>
	<li class="li1">
      <?php
						...
						switch ($listTypes) {
							case '1' :
								?>
        <span class="list_list" rel="nofollow">List</span> <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'listtypes=2' ) . cleanSameArgNoHtml('listtypes');?>" rel="nofollow" ><span
		class="list_grid" rel="nofollow">Grid</span></a> <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'listtypes=3' ) . cleanSameArgNoHtml('listtypes');?>" rel="nofollow" ><span
		class="list_gallery" rel="nofollow">Gallery</span></a>    
      <?php
								break;
							case '2' :
								?>
        <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'listtypes=1' ) . cleanSameArgNoHtml('listtypes');?>" rel="nofollow"><span
		class="list_list" rel="nofollow">List</span></a> <span class="list_grid" rel="nofollow">Grid</span>
	<a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'listtypes=3' ) . cleanSameArgNoHtml('listtypes');?>" rel="nofollow"><span
		class="list_gallery" rel="nofollow">Gallery</span></a>  
      <?php
		...
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'listtypes=1' ) . cleanSameArgNoHtml('listtypes');?>" rel="nofollow" ><span
		class="list_list" rel="nofollow">List</span></a> <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'listtypes=2' ) . cleanSameArgNoHtml('listtypes');?>" rel="nofollow" ><span
		class="list_grid" rel="nofollow">Grid</span></a> <span class="list_gallery" rel="nofollow">Gallery</span>       
      <?php
								break;
						}
						?>
	...
	<li class="li2">
      <?php
						switch ($display) {
							case '1' :
								?> 
      <span class="category_" rel="nofollow">ALL</span> <span class="category"> <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'display=2' ) . cleanSameArgNoHtml ( 'display' );
								?>" rel="nofollow">
	Wholesale Only </a> </span> <span class="category"> <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'display=3' ) . cleanSameArgNoHtml ( 'display' );
								?>" rel="nofollow">
	Free Shipping </a> </span>
      ...
      <span class="category"><a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'display=1' ) . cleanSameArgNoHtml ( 'display' );
								?>" rel="nofollow">ALL</a></span>
	<span class="category_" rel="nofollow">Wholesale Only</span> <span class="category" rel="nofollow"> <a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'display=3' ) . cleanSameArgNoHtml ( 'display' );
								?>" rel="nofollow">
	Free Shipping </a> </span>
      ...
      <span class="category"><a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'display=1' ) . cleanSameArgNoHtml ( 'display' );
								?>" rel="nofollow">ALL</a></span>
	<span class="category" rel="nofollow"><a
		href="<?php
								echo zen_href_link ( FILENAME_PRODUCTS_NEW, 'display=2' ) . cleanSameArgNoHtml ( 'display' );
								?>" rel="nofollow">Wholesale
	Only</a></span> <span class="category_" rel="nofollow">Free Shipping</span>
      <?php
								break;
						}
						?>
      </li>
	<li rel="nofollow"><strong>Sorted By: </strong><?php
	...
	?></li>
	<li rel="nofollow"><strong>Show: </strong> <?php
