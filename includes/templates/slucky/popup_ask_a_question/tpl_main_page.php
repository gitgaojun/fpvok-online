...
<h2 class="border_b line_30px"><a class="fr font_normal" target="_blank" href="<?php echo zen_href_link(FILENAME_FAQS_ALL,'','SSL'); ?>"><?php echo zen_image($template->get_template_dir('help.gif', DIR_WS_TEMPLATE, $current_page_base,'images/button'). '/help.gif') ?></a><?php echo HEADING_TITLE .' - '. $product_info->fields['products_name']; ?></h2>
...
<?php echo '<a href="' . zen_href_link(zen_get_info_page($_GET['products_id']), 'products_id=' . $_GET['products_id']) . '" class="fr margin_t">' . zen_image(DIR_WS_IMAGES . $product_info->fields['products_image'], SEO_COMMON_KEYWORDS . ' ' .$product_info->fields['products_name'], 85, 85) . '</a>'; ?>
