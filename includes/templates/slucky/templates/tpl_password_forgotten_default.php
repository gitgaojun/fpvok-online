...
<?php echo '<br/>'.zen_draw_input_field('email_address', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' id="email-address" class="l_input"') . '&nbsp;' . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="red">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?>
<br class="clear" />
</fieldset>

<div class="pad_10px fl" style="padding-left: 1px;"><?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div> 
