...
<li class="margin_t">
<?php echo ENTRY_PASSWORD . '<span class="red">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>'; ?><br />
...
<li class="margin_t hide">
<?php echo ENTRY_WHICH_BEST_YOU; ?><br />
<?php echo zen_draw_pull_down_menu('describes',$bestYouArray,'',' chkname="Which one describes you the best?" style="width: 120px;"'); ?>
</li>
<li class="margin_t hide">
...
<li class="margin_t hide">
<input type="checkbox" chkname="You must agree to our Terms of Use" checked="checked" value="1" name="privacy_conditions"/>
  Please agree to our
