...
if(!$this_is_home_page){
	...
	require('includes/languages/english/html_includes/define_page_3.php'); 
    require('includes/modules/left_featued.php'); 
...
<center><?php echo zen_display_banner('static', $banner); ?></center>
</div>
<?php
	}
}
...
echo '</div><div class="right_big_con margin_t"></div>';
