  ...
  <tr>
   ...
   <tr>
      ...
      <tr>
        ...
        <td colspan="3"><?php echo zen_draw_input_field('postcode', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_postcode', '40') . ' chkname="Post/ZIP Code" chkrule="nnull/min4" id="postcode" class="s_input"') ; ?>
        </td>
      </tr>
      <tr>
...
<DIV class=pad_1em><INPUT id=isSame 
onclick="showBilling();tosame();update_billing_zone($('checkout_address'));" 
value=true type=checkbox name=isSame> <LABEL class="b hand" for=isSame>My 
billing address is the same as my shipping address<BR></LABEL>If you have 
different billing address or you are drop ship customer, <A 
href="javascript:$('isSame').checked=false;showBilling();update_billing_zone($('checkout_address'));">Please 
Enter your Billing Address</A> </DIV>
<DIV id=billingDiv>
<DIV class="pad_1em margin_t">
<H4>Billing Address:</H4><SPAN class=red>*</SPAN> Indicates required 
fields<BR>Please ensure this information matches your credit card statement.
<H2></H2></DIV>
<table width="500" cellspacing="0" cellpadding="0" border="0" class="margin_t address_tb" align="center">
   <tbody>
  <tr>
        ...
        $genderArray[] = array('id'=> 'm','text'=> MALE);
        $genderArray[] = array('id'=> 'f','text'=> FEMALE);
		    echo zen_draw_pull_down_menu('b_gender',$genderArray,'','chkname="Gender" chkrule="isselect" class="s_select" id="b_gender"'); ?>
		  </td>
   ...
   <tr>
      ...
      <td colspan="3">
      <div class="fl" style="width: 120px;">
      <?php echo zen_draw_input_field('b_firstname', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_firstname', '40') . ' id="b_firstname" class="s_input"  chkrule="nnull/min2" chkname="firstname"'); ?>
      </div>
      <div style="width: 100px;" class="fl g_t_r b"><?php echo ENTRY_LAST_NAME; ?><span class="red">*</span></div>
      <div class="fl" style="width: 120px;">
      <?php echo zen_draw_input_field('b_lastname', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_lastname', '40') . 'chkrule="nnull/min2" chkname="lastname" id="b_lastname" class="s_input"'); ?>
      </div>
      </td>
      </tr>
      <tr>
        <td class="g_t_r b"><?php echo ENTRY_STREET_ADDRESS; ?><span class="red">*</span></td>
        <td colspan="3">
        <div><?php echo zen_draw_input_field('b_street_address', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_street_address', '40') . ' chkrule="nnull/min5" chkname="Street Address" id="b_street-address" class="l_input"') ; ?>
        </div>
        Notice: P.O. boxes Addresses are not available for shipping right now,
        <br/>
        so please provide street address for your order. Thank you. 
      ...
      <tr>
        <td class="g_t_r b"><?php echo ENTRY_SUBURB; ?></td>
        <td colspan="3">
        <?php echo zen_draw_input_field('b_suburb', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_suburb', '40') . ' id="b_suburb" class="l_input"'); ?>
        <div class="line_120">Apartment, suite, unite, building, floor, etc.</div>
        </td>
      </tr>
      <tr>
        <td class="g_t_r b"><?php echo ENTRY_CITY; ?><span class="red">*</span></td>
        <td colspan="3"><?php echo zen_draw_input_field('b_city', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_city', '40') . ' chkrule="nnull/min3" chkname="City" id="b_city" class="l_input"'); ?>
        </td>
      </tr>
      <tr>
        <td class="g_t_r b"><?php echo ENTRY_COUNTRY; ?></td>
        <td colspan="3"><?php echo zen_get_country_list('b_zone_country_id', $selected_country, ' chkname="Country / Region" chkrule="isselect" id="b_country"  class="l_select" onchange="update_billing_zone(this.form);"'); ?>
        </td>
      </tr>
			<tr id="zone_id_tr2">
			  <td class="g_t_r b"><?php echo ENTRY_STATE.(zen_not_null(ENTRY_STATE_TEXT)?'&nbsp;<span class="red">' . ENTRY_STATE_TEXT . '</span>':''); ?></td>
			  <td colspan="3"><select id="b_stateZone" class="l_select" chkname="State/Province/Region" chkrule="isselect"  name="b_zone_id">  </select>
			</td></tr>
			<tr id="zone_id_tr3" style="display:none;">
			  <td align="right"><strong><?php echo ENTRY_STATE.(zen_not_null(ENTRY_STATE_TEXT)?'&nbsp;<span class="red">' . ENTRY_STATE_TEXT . '</span>':''); ?></strong></td>
			  <td colspan="3"><input id="b_state" type="text" class="l_input" maxlength="40" value="<?php echo ($entry->fields['entry_zone_id']==0)?$entry->fields['entry_state']:$entry->fields['entry_zone_id']; ?>" name="b_state"/></td>
		  </tr>
      <tr>
        <td class="g_t_r b"><?php echo ENTRY_POST_CODE; ?><span class="red">*</span></td>
        <td colspan="3"><?php echo zen_draw_input_field('b_postcode', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_postcode', '40') . ' chkname="Post/ZIP Code" chkrule="nnull/min4" id="b_postcode" class="s_input"') ; ?>

        </td>
      </tr>
      <tr>
        <td class="g_t_r b"><?php echo ENTRY_PHONE_NUMBER; ?><span class="red">*</span></td>
        <td colspan="3"><?php echo zen_draw_input_field('b_phone', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_phone', '40') . 'chkname="Phone" chkrule="nnull/min4/tel" class="s_input" id="b_phone"') ; ?>
        </td>
      </tr>
      <tr>
        <td class="g_t_r b"></td>
