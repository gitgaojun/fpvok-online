...
<ul class="margin_t" style="padding-left: 18px;">
                    ...
                    <ul class="big1">
                      <?php echo zen_output_string_protected(($reviews->fields['customers_name'] != ''?$reviews->fields['customers_name']:'Guest')); ?>, from United Kingdom
                    </ul>
    ...
    <ul style="padding-left: 98px; margin-top: 17px;">
            ...
            <ul class="big3">
              <?php echo zen_output_string_protected(($reviews->fields['customers_name'] != ''?$reviews->fields['customers_name']:'Guest')); ?>, from USA
            </ul>
              <ul class="blue"><?php echo zen_date_short($reviews->fields['date_added']); ?></ul>
                    </div>
                    </li>
...
<ul style="padding-left: 65px; margin-top: 17px;">
                    ...
                    <div style="padding: 40px 0pt 0pt 65px;">
                    <ul class="big3">
                      <?php echo zen_output_string_protected(($reviews->fields['customers_name'] != ''?$reviews->fields['customers_name']:'Guest')); ?>, from Germany
                    </ul>
                      <ul class="blue"><?php echo zen_date_short($reviews->fields['date_added']); ?></ul>
                            </div>
                            </li>
...
<ul style="padding-left: 133px; margin-top: 40px;">
     ...
     <?php break;
           ...
           <ul class="border_b">
                                    ...
                                    <li class="g_t_r black"><?php echo zen_output_string_protected(($reviews->fields['customers_name'] != ''?$reviews->fields['customers_name']:'Guest')); ?>, from France<br/>
