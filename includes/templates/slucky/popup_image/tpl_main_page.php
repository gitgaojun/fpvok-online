...
<?php
    echo zen_image_OLD($products_image_large[0], SEO_COMMON_KEYWORDS . ' ' .addslashes($products_name), '500', '500','id="ZoomBox_i" class="relative" ') ; ?>
...
?>
  <body id="popupImage" class="centeredContent" onLoad="resize();">
   <a href="javascript:window.close()" target="_self"> <?php echo zen_image_OLD($products_image_large, SEO_COMMON_KEYWORDS . ' ' .addslashes($products_name) . ' ' . TEXT_CLOSE_WINDOW); ?> </a> 
  </body>
<?php
  }
?>
