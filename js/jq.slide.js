(function(jQuery){
	jQuery.fn.Slide=function(options){
		...
		var index=1;
		var targetLi = jQuery("." + opts.claNav + " li", jQuery(this));//target
		var clickNext = jQuery("." + opts.claNav + " .next", jQuery(this));//click next
		var clickPrev = jQuery("." + opts.claNav + " .prev", jQuery(this));//click prev
		var ContentBox = jQuery("." + opts.claCon , jQuery(this));//scroll elem
		var ContentBoxNum=ContentBox.children().size();//scroll elems count
		var slideH=ContentBox.children().first().height();//scroll height
		var slideW=ContentBox.children().first().width();//scroll width
		var autoPlay;
		var slideWH;
